...
| 2 — Backend + apps/web (MVP) | 🟡 En progreso — frontend (`apps/web`) completo; backend: Sprint 0 (cimientos), Sprint 1 (seguridad), Sprint 2 (descarga masiva vía Celery, verificado con una descarga real) y Sprint 3 (resguardo/validación/consulta, verificado con los 76 CFDI reales de Sprint 2) cerrados 2026-07-28; Sprints 4-5 (sync/EFOS/notificaciones, endurecimiento) pendientes | Parcial (frontend + Sprint 0-3 backend) |
